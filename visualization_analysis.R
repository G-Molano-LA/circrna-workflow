...
histogram <-
  ...
  scale_y_continuous(trans = "log10",breaks = c(1, 10, 100, maxval_2, maxval), 
                     labels = c(1, 10, 100, maxval_2, maxval))+
  ylab("Frequency of circRNAs") +
